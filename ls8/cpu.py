...
class CPU:
    ...
    def run(self):
        ...
        while running:
            ...
            operation_one = self.ram_read(self.pc + 1)
            operation_two = self.ram_read(self.pc + 2)

            if instruction == LDI:
                # set value of a register to an integer
                self.reg[operation_one] = operation_two
                self.pc += 3
                ...
                print(self.reg[operation_one])
                self.pc += 2

            elif instruction == ADD:
                self.reg[operation_one] += self.reg[operation_two]
                self.pc += 3

            elif instruction == MUL:
                # multiply the values in two registers and the result in register A.
                self.reg[operation_one] *= self.reg[operation_two]
                # result = self.reg[operation_one] * self.reg[operation_two]
                # print("multiply result", result)
                self.pc += 3

            elif instruction == PUSH:
                # push the value in the given register on the stack
                val = self.reg[operation_one]
                # decrement the SP
                self.reg[self.sp] -= 1
                ...
                subroutine_address = self.reg[operation_one]
                ...
                # print("a", operation_one)
                # print("b", operation_two)
                if self.reg[operation_one] == self.reg[operation_two]:
                    self.fl = 1
                else:
                    self.fl = 0
                self.pc += 3
                ...
                self.pc = self.reg[operation_one]
                # print("jumped", self.pc)
